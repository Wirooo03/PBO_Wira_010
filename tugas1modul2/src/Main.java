...
class Main {
    static Book[] bookList = {
            new Book(1, "Atomic Habits", "James Clear", "Self Improvement"),
            new Book(2, "48 Laws of Power", "Robert Greene", "Politics & Social"),
            new Book(3, "The Psychology of Money", "Morgan Housel", "Economy")
    };
